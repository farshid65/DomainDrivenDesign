...
{
    public class EFClassifiedAdsApplicationService : IApplicationService
    {
        ...
        public EFClassifiedAdsApplicationService(IClassifiedAdRepository repository, IUnitofWork unitofWork, ICurrencyLookup currencyLookup)
        {
        ...
        private async Task HandleUpdate(
            Guid classifiedAdId, Action<Core.Domain.ClassifiedAds.ClassifiedAd> operation)
        {
